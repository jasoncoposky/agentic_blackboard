...
int main() {
    try {
        ...
        // Agents
        ab::IdentityNode agent1 = {"Nexus_Agent_7", "Nexus Agent 7", "Lead Architect", "pub-key-n7"};
        ab::IdentityNode agent2 = {"auditor-prime", "Auditor Prime", "SWEBOK Compliance", "pub-key-ap"};
        bb.commit_identity_node(agent1);
        bb.commit_identity_node(agent2);

        // Projects
        ab::ProjectNode proj1 = {"ALPHA_SWARM", "Distributed Resilience Initiative", "ACTIVE"};
        ab::ProjectNode proj2 = {"shakedown-final", "Final Integration Verification", "ACTIVE"};
